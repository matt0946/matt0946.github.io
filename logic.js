...
function activateDarkMode() {
  ...
  var circles = document.querySelectorAll(".cursor");
  circles.forEach(function (circle, index) {
    circle.style.backgroundColor = colors[index % colors.length];
  });

  document.querySelector(".cursor-button-image").src = "images/cursor-dark.png";
}
...
function activateLightMode() {
  ...
  document.querySelector(".cursor-button-image").src =
    "images/cursor-light.png";
}

// const coords = { x: 0, y: 0 };
// const cursorsCircles = document.querySelectorAll(".cursor");
// const cursorColors = [
//   "#1f005c",
//   "#37176a",
//   "#4c2d78",
...
//   "#ffffff",
// ];
// cursorsCircles.forEach(function (circle, index) {
//   circle.x = 0;
//   circle.y = 0;
...
//     circle.style.scale =
//       (cursorsCircles.length - index) / cursorsCircles.length;

//     circle.x = x;
//     circle.y = y;

//     const nextCircle = cursorsCircles[index + 1] || cursorsCircles[0];
...
let specialCursorEnabled = false;
...
function toggleCursor() {
  ...
  specialCursorEnabled = !specialCursorEnabled;

  if (!specialCursorEnabled) {
    var documents = document.querySelector("html");
    documents.style.cursor = "auto";
  } else {
    var documents = document.querySelector("html");
    documents.style.cursor = "none";
  }
}
